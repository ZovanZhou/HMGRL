...
class ZeroShotMRelModel(tf.keras.models.Model):
    def __init__(self, encoder, use_img):
        super(ZeroShotMRelModel, self).__init__()
...
class ZeroShotMRelFramework(object):
    def __init__(
        self,
        train_dataloader,
        val_dataloader,
    ...
    def train(
        ...
        for e in range(1, epoch + 1):
            ...
            val_metrics, val_loss, gamma = self.eval(model, val_iter)
    ...
    def eval(self, model, val_iter, do_test: bool = False, model_path: str = "", gamma: float = -1.0):
        n_seen_class = self.__train_n_class
        if model_path:
        ...
        for _ in range(val_iter):
            ...
            logit = model(val_data, n_seen_class, n_unseen_class)
        ...
        return dict_metrics, loss, gamma