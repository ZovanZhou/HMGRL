...
class MMProto(ZeroShotMNetModel):
    ...
    def call(self, data, n_seen_class, n_unseen_class, training=False):
        data = self.unpack_data(data)
        _, _, h_entity, h_mm_entity, h_seen_label, h_unseen_label, h_seen_entity, h_unseen_entity, overall_loss = self.encoder(*data, training=training)
